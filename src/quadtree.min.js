...
!(function () {
	...
	;(o.prototype.split = function () {
		var t = this.level + 1,
			...
			i = this.bounds.y
		;(this.nodes[0] = new o(
			{ x: h + e, y: i, width: e, height: s },
			this.max_objects,
			this.max_levels,
			t
		)),
			(this.nodes[1] = new o(
				{ x: h, y: i, width: e, height: s },
				this.max_objects,
				this.max_levels,
				t
			)),
			(this.nodes[2] = new o(
				{ x: h, y: i + s, width: e, height: s },
				this.max_objects,
				this.max_levels,
				t
			)),
			(this.nodes[3] = new o(
				{ x: h + e, y: i + s, width: e, height: s },
				this.max_objects,
				this.max_levels,
				t
			))
		...
		(o.prototype.insert = function (t) {
			...
			if (this.nodes.length)
				for (e = this.getIndex(t), s = 0; s < e.length; s++)
					this.nodes[e[s]].insert(t)
			else if (
				(this.objects.push(t),
				...
				for (
					this.nodes.length || this.split(), s = 0;
					s < this.objects.length;
					s++
				) {
					e = this.getIndex(this.objects[s])
					for (var h = 0; h < e.length; h++)
						this.nodes[e[h]].insert(this.objects[s])
				}
				this.objects = []
			}
		}),
		(o.prototype.retrieve = function (t) {
			...
			return 0 === this.level ? Array.from(new Set(s)) : s
		}),
